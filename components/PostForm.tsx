      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <input
            ...
            className="flex-1 outline-none rounded-full py-3 px-4 border text-black placeholder-gray-500"
            value={postInput}
          ...
          <Button
            type="submit"
            className="ml-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full px-4 py-2 flex items-center"
